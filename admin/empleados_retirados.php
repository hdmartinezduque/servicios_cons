...
$tabla = ' empleado_retirado ER LEFT JOIN empleado E ON ER.id_empleado = E.id_empleado';
...
foreach($data_empleados as $row){
  ...
  if($editar>0){
    $consulta_empleados .='<td>'.$row['cedula'].'<a href="'.$edicion.'"> <img src="../img/pen.png" height="16" width="16" align = right title="Click para Editar"></a></td>';
  }else{
...
if(empty($_SESSION['userid']))
{
    ...
    $return .= $body_head;
    $return .= $menu;
    $return .= imp_print::contenido('', $consulta_empleados, '');
